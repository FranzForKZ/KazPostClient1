...
HelloWorld.py - пробный python com object
UnitTest1.cs - вызов метода Hello из объекта
...
Для запуска нужно поставить: dlib, OpenCV, numpy, sklearn, cPickle,scipy
conda install numpy=1.10.4
conda install scikit-learn=0.17
conda install -c anaconda cloudpickle=0.2.1
conda install -c menpo opencv3=3.1.0
conda install -c menpo dlib=18.18 (аналог pip install dlib или вручную https://pypi.python.org/pypi/dlib/18.17.100)
для windows xp embdded потребовалась ручная установка скомпилированных библиотек отсюда:
http://www.lfd.uci.edu/~gohlke/pythonlibs/
https://pypi.python.org/pypi/dlib/18.17.100   - нужный dlib

PATH
C:\install\anaconda;C:\install\anaconda\Scripts;C:\install\anaconda\Library\bin

изменить путь в файле frame_quality_analyser.py
PYTHON_SRC_PATH = 
на папку с PythonSrc
